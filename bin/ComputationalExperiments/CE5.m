...
% Write to file
dlmwrite('CE5_networkPrecision.tsv',networkPrecision,'\t');
dlmwrite('CE5_ensemblePrecision.tsv',ensemblePrecision,'\t');
dlmwrite('CE5_networkRecall.tsv',networkRecall,'\t');
dlmwrite('CE5_ensembleRecall.tsv',ensembleRecall,'\t');
dlmwrite('CE5_networkAccuracy.tsv',networkAccuracy,'\t');
