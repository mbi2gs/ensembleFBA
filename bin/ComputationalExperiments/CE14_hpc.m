function [] = CE14_hpc(MaxGCs,N_gcs,MaxNGCs,N_ngcs,fraction,rndSeed,resultsFileName)
% Computational Experiment (HPC part)
% Generate networks for CE14
%
...
p1 = randperm(length(rxnList), ceil(fraction*length(rxnList)));
rxnList = rxnList(p1);
